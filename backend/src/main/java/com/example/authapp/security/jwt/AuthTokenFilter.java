 ...
 * Reads the "Authorization: Bearer <token>" header, validates it, and if
 * valid, populates the SecurityContext so downstream authorization
 * (hasRole/hasAuthority, @PreAuthorize, etc.) works for this request.
 */
